...
define('MODULE_PAYMENT_MOLLIE_SOFORT_ORDER_EXPIRES_TITLE', '<span class="mollie_order_expires_title">Dagen tot verstrijken</span>');
define('MODULE_PAYMENT_MOLLIE_SOFORT_ORDER_EXPIRES_DESC', '<span class="mollie_order_expires_desc">Hoeveel dagen voordat bestellingen voor deze methode verlopen? Laat leeg om de standaard vervaldatum te gebruiken (28 dagen)</span>');

define('MODULE_PAYMENT_MOLLIE_SOFORT_TRANSACTION_DESCRIPTION_TITLE', '<span class="mollie_transaction_description_title">Transactiebeschrijving</span>');
...
define('MODULE_PAYMENT_MOLLIE_SOFORT_SURCHARGE_TYPE_TITLE', 'Betalingstoeslag');
define('MODULE_PAYMENT_MOLLIE_SOFORT_SURCHARGE_TYPE_DESC', 'Selecteer het type toeslag.');

define('MODULE_PAYMENT_MOLLIE_SOFORT_SURCHARGE_FIXED_AMOUNT_TITLE', 'Betalingstoeslag vast bedrag');
define('MODULE_PAYMENT_MOLLIE_SOFORT_SURCHARGE_FIXED_AMOUNT_DESC', 'Extra kosten die aan de klant worden doorberekend voor betalingstransacties bepaald als een vast bedrag in standaard winkelvaluta.');

define('MODULE_PAYMENT_MOLLIE_SOFORT_SURCHARGE_PERCENTAGE_TITLE', 'Betalingstoeslag percentage');
define('MODULE_PAYMENT_MOLLIE_SOFORT_SURCHARGE_PERCENTAGE_DESC', 'Extra kosten die aan de klant worden doorberekend voor betalingstransacties bepaald als een percentage van het subtotaal van de winkelwagen.');

define('MODULE_PAYMENT_MOLLIE_SOFORT_SURCHARGE_LIMIT_TITLE', 'Betalingstoeslag limiet');
