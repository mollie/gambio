...
defined('MODULE_PAYMENT_MOLLIE_BANCONTACT_ORDER_EXPIRES_TITLE') ?: define('MODULE_PAYMENT_MOLLIE_BANCONTACT_ORDER_EXPIRES_TITLE', '<span class="mollie_order_expires_title">Dagen tot verstrijken</span>');
defined('MODULE_PAYMENT_MOLLIE_BANCONTACT_ORDER_EXPIRES_DESC') ?: define('MODULE_PAYMENT_MOLLIE_BANCONTACT_ORDER_EXPIRES_DESC', '<span class="mollie_order_expires_desc">Hoeveel dagen voordat bestellingen voor deze methode verlopen? Laat leeg om de standaard vervaldatum te gebruiken (28 dagen)</span>');

defined('MODULE_PAYMENT_MOLLIE_BANCONTACT_TRANSACTION_DESCRIPTION_TITLE') ?: define('MODULE_PAYMENT_MOLLIE_BANCONTACT_TRANSACTION_DESCRIPTION_TITLE', '<span class="mollie_transaction_description_title">Transactiebeschrijving</span>');
...
defined('MODULE_PAYMENT_MOLLIE_BANCONTACT_SURCHARGE_LIMIT_DESC') ?: define('MODULE_PAYMENT_MOLLIE_BANCONTACT_SURCHARGE_LIMIT_DESC', 'Maximumbedrag van de betalingstoeslag die aan de klant moet worden doorberekend (in standaard winkelvaluta).');
