...
defined('MODULE_PAYMENT_MOLLIE_BANCONTACT_ORDER_EXPIRES_DESC') ?: define('MODULE_PAYMENT_MOLLIE_BANCONTACT_ORDER_EXPIRES_DESC', 'Hoeveel dagen voordat bestellingen voor deze methode verlopen? Laat leeg om de standaard vervaldatum te gebruiken (28 dagen)');
