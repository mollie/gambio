...
defined('MODULE_PAYMENT_MOLLIE_BILLIE_ORDER_EXPIRES_TITLE') ?: define('MODULE_PAYMENT_MOLLIE_BILLIE_ORDER_EXPIRES_TITLE', 'Days To Expire');
defined('MODULE_PAYMENT_MOLLIE_BILLIE_ORDER_EXPIRES_DESC') ?: define('MODULE_PAYMENT_MOLLIE_BILLIE_ORDER_EXPIRES_DESC', 'How many days before orders for this method becomes expired? Leave empty to use default expiration (28 days)<br><br>Please note: It is not possible to use an expiry date more than 28 days in the future, unless another maximum is agreed between the merchant and Billie.');
