...
defined('MODULE_PAYMENT_MOLLIE_KLARNA_TEXT_DESCRIPTION') ?: define('MODULE_PAYMENT_MOLLIE_KLARNA_TEXT_DESCRIPTION', 'You will be redirected to payment gateway website to complete your purchase after the order review step.');

defined('MODULE_PAYMENT_MOLLIE_KLARNA_STATUS_TITLE') ?: define('MODULE_PAYMENT_MOLLIE_KLARNA_STATUS_TITLE', 'Enable payment method');
defined('MODULE_PAYMENT_MOLLIE_KLARNA_STATUS_DESC') ?: define('MODULE_PAYMENT_MOLLIE_KLARNA_STATUS_DESC', 'Do you want to accept Klarna as payments?');
...
defined('MODULE_PAYMENT_MOLLIE_KLARNA_CHECKOUT_NAME_DESC') ?: define('MODULE_PAYMENT_MOLLIE_KLARNA_CHECKOUT_NAME_DESC', 'Please define name that will be used in checkout.');

defined('MODULE_PAYMENT_MOLLIE_KLARNA_CHECKOUT_DESCRIPTION_TITLE') ?: define('MODULE_PAYMENT_MOLLIE_KLARNA_CHECKOUT_DESCRIPTION_TITLE', 'Checkout description');
defined('MODULE_PAYMENT_MOLLIE_KLARNA_CHECKOUT_DESCRIPTION_DESC') ?: define('MODULE_PAYMENT_MOLLIE_KLARNA_CHECKOUT_DESCRIPTION_DESC', 'Please define description text that will be used in checkout.');

defined('MODULE_PAYMENT_MOLLIE_KLARNA_ALLOWED_ZONES_TITLE') ?: define('MODULE_PAYMENT_MOLLIE_KLARNA_ALLOWED_ZONES_TITLE', 'Allow payment to specific countries');
