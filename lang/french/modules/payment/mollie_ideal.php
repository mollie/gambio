...
defined('MODULE_PAYMENT_MOLLIE_IDEAL_API_METHOD_DESC') ?: define('MODULE_PAYMENT_MOLLIE_IDEAL_API_METHOD_DESC', "<b>Payment API</b><br>Utilisez la plateforme Payment API pour les transactions. <a href='https://docs.mollie.com/payments/overview' target='_blank'>Reaad more</a>..<br>");
...
defined('MODULE_PAYMENT_MOLLIE_IDEAL_CAPTURE_OPTION_TITLE') ?: define('MODULE_PAYMENT_MOLLIE_IDEAL_CAPTURE_OPTION_TITLE', 'Paiement capture');
defined('MODULE_PAYMENT_MOLLIE_IDEAL_CAPTURE_OPTION_DESC') ?: define('MODULE_PAYMENT_MOLLIE_IDEAL_CAPTURE_OPTION_DESC', '<b>Sélectionnez un type de capture.<br>');
