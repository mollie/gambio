...
defined('MODULE_PAYMENT_MOLLIE_KLARNA_ORDER_EXPIRES_TITLE') ?: define('MODULE_PAYMENT_MOLLIE_KLARNA_ORDER_EXPIRES_TITLE', "Jours d'expiration");
defined('MODULE_PAYMENT_MOLLIE_KLARNA_ORDER_EXPIRES_DESC') ?: define('MODULE_PAYMENT_MOLLIE_KLARNA_ORDER_EXPIRES_DESC', "Combien de jours avant l'expiration des commandes pour cette méthode? Laissez vide pour utiliser l'expiration par défaut (28 jours)<br><br>Remarque: il n'est pas possible d'utiliser une date d'expiration de plus de 28 jours dans le futur, à moins qu'un autre maximum ne soit convenu entre le commerçant et Klarna.");
