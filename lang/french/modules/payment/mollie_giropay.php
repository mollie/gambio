...
define('MODULE_PAYMENT_MOLLIE_GIROPAY_ORDER_EXPIRES_TITLE', "Jours d'expiration");
...
define('MODULE_PAYMENT_MOLLIE_GIROPAY_SURCHARGE_TYPE_TITLE', 'Majoration de paiement');
define('MODULE_PAYMENT_MOLLIE_GIROPAY_SURCHARGE_TYPE_DESC', 'Veuillez sélectionner un type de majoration.');

define('MODULE_PAYMENT_MOLLIE_GIROPAY_SURCHARGE_FIXED_AMOUNT_TITLE', 'Montant fixe pour majoration de paiement');
define('MODULE_PAYMENT_MOLLIE_GIROPAY_SURCHARGE_FIXED_AMOUNT_DESC', 'Coût supplémentaire à facturer au client pour les opérations de paiement défini comme un montant fixe dans la devise du magasin par défaut.');

define('MODULE_PAYMENT_MOLLIE_GIROPAY_SURCHARGE_PERCENTAGE_TITLE', 'Pourcentage de majoration de paiement');
define('MODULE_PAYMENT_MOLLIE_GIROPAY_SURCHARGE_PERCENTAGE_DESC', 'Coût supplémentaire à facturer au client pour les opérations de paiement défini comme un pourcentage du sous-total du panier.');

define('MODULE_PAYMENT_MOLLIE_GIROPAY_SURCHARGE_LIMIT_TITLE', 'Limite de majoration de paiement');
