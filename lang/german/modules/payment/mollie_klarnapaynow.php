...
defined('MODULE_PAYMENT_MOLLIE_KLARNAPAYNOW_CAPTURE_OPTION_TITLE') ?: define('MODULE_PAYMENT_MOLLIE_KLARNAPAYNOW_CAPTURE_OPTION_TITLE', 'Zahlung erfassen');
defined('MODULE_PAYMENT_MOLLIE_KLARNAPAYNOW_CAPTURE_OPTION_DESC') ?: define('MODULE_PAYMENT_MOLLIE_KLARNAPAYNOW_CAPTURE_OPTION_DESC', '<b>Wählen Sie einen Erfassungsmodus.<br>');
