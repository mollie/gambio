...
defined('MODULE_PAYMENT_MOLLIE_KLARNAPAYNOW_CAPTURE_OPTION_TITLE') ?: define('MODULE_PAYMENT_MOLLIE_KLARNAPAYNOW_CAPTURE_OPTION_TITLE', 'Payment capture');
defined('MODULE_PAYMENT_MOLLIE_KLARNAPAYNOW_CAPTURE_OPTION_DESC') ?: define('MODULE_PAYMENT_MOLLIE_KLARNAPAYNOW_CAPTURE_OPTION_DESC', '<b>Select a capture type.<br>');
