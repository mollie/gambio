...
define('MODULE_PAYMENT_MOLLIE_PRZELEWY24_API_METHOD_DESC', '<b>Payment API</b><br>Use the Payment API Platform for the transactions.<br><br><b>Order API</b><br>Use the new Order API Platform and get additional insights in the orders.');
