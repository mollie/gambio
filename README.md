...
Step-by-step to install the Gambio module:
 ...
 2. Copy the all content of the `gambio-0.1.0` directory from the extracted files to the root of your Gambio store on your webserver using your FTP client.
