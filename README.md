...
# Release notes
- 2.0.2: Removed thousand separator when sending amount to Mollie API.
- 2.0.1: Translations for NL, DE, and FR are added.
- 2.0.0: The initial release of Mollie integration with Gambio.