...
$t_language_text_section_content_array = [
    ...
    'mollie_refunds'                 => 'Erstattungen',
    'mollie_open_in_mollie'          => 'In Mollie öffnen',
    'mollie_payment_link_message'    => 'Ist Ihre Zahlung noch ausstehend? Kopieren Sie den Zahlungslink und senden Sie ihn Ihrem Kunden. Der Link führt ihn auf die Checkout-Seite, wo er die Zahlung erneut veranlassen kann.',
    'mollie_items'                   => 'Artikel',
    'mollie_amount'                  => 'Betrag',
    'mollie_model'                   => 'Modell',
    'mollie_products'                => 'Betrag',
    'mollie_ordered_qty'             => 'Bestellte Menge',
    'mollie_shipped_qty'             => 'Gelieferte Menge',
    'mollie_shipped_at'              => 'Versandt am',
    'mollie_qty_to_ship'             => 'Versandmenge',
    'mollie_carrier'                 => 'Logistikdienstleister',
    'mollie_tracking_code'           => 'Sendungsnummer',
    'mollie_tracking_url'            => 'Tracking-URL',
    'mollie_submit_shipment'         => 'Sendung einreichen',
    'mollie_copy_to_clipboard'       => 'In die Zwischenablage kopieren',
    'mollie_refund'                  => 'Erstattung',
    'mollie_refunded_qty'            => 'Erstattete Menge',
    'mollie_qty_to_refund'           => 'Zu erstattende Menge',
    'mollie_payment_refund'          => 'Rückzahlung',
    'mollie_refund_amount'           => 'Erstattungsbetrag',
    'mollie_refund_reason'           => 'Erstattungsgrund',
    'mollie_total'                   => 'Gesamt',
    'mollie_price'                   => 'Preis',
    'mollie_refund_message'          => 'Diese Zahlung wurde als Teil einer Bestellung getätigt. Es wird empfohlen, einzelne Bestellpositionen zu erstatten.',
    'mollie_total_refunded'          => 'Betrag bereits erstattet',
    'mollie_available_to_refund'     => 'Verbleibender Betrag zur Rückerstattung',
    'mollie_refund_success'          => 'Rückzahlung erfolgreich',
    'mollie_refund_error'            => 'Zahlung kann nicht erstattet werden. Antwort Mollie-API: ',
    'mollie_not_refundable'          => 'Gesamtbetrag wurde bereits zurückerstattet',
    'mollie_not_shippable'           => 'Alle Artikel wurden bereits versandt.',
    'mollie_shipment_create_success' => 'Sendung erfolgreich in Mollie erstellt',
    ...
    'mollie_single_click_payment_approval_text' => 'Kreditkartendaten für zukünftige Einkäufe hinterlegen',
    'mollie_single_click_payment_desc' => 'Sie haben Ihre Kartendaten bereits hinterlegt. Sie werden zu Mollie weitergeleitet.',
    'mollie_surcharge_type_no_fee'   => 'Keine Gebühr',
    'mollie_surcharge_type_fixed_fee' => 'Feste Gebühr',
    'mollie_surcharge_type_percentage' => 'Anteil',
    'mollie_surcharge_type_fixed_fee_and_percentage' => 'Feste Gebühr und Anteil',
    ...
    'mollie_card_holder'             => 'Name des Karteninhabers',
    'mollie_card_number'             => 'Kreditkartennummer',
    'mollie_expiry_date'             => 'MM/JJ',
    'mollie_verification_code'       => 'CVV',
    'mollie_use_saved_credit_card_text' => 'Hinterlegte Kreditkartendaten verwenden',
